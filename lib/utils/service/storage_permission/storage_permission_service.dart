...
class StoragePermissionService {
  ...
  static Future<void> requestStoragePermission() async {
    ...
    if (permissionStatus) {
      /// Initialize the global storage stream variable
      RootStorageData.getRootStorageData();
    }
  }
      ...
      showModalBottomSheet(
        ...
        builder: (context) {
          return Container(
            ...
            decoration: BoxDecoration(color: Color.fromRGBO(243, 243, 250, 1)),
            child: Column(
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(Icons.check, size: 17.sp, color: AppColors.white),
                        SizedBox(width: 6.w),
                        Text(
                          "Continue",
                          style: GoogleFonts.googleSans(
